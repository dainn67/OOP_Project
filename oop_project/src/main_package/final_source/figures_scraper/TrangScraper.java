...
//						Figure myFigure = search(figureList, normalizeString(name));
						Figure myFigure = search(figureList, HelperFunctions.normalizeString(name));
						if(myFigure != null) System.out.println(HelperFunctions.normalizeString(name) + " (FOUND)");
						else continue;
						...
						String figureLink = linkElement.selectFirst("a").attr("href");

//						System.out.println("Name: " + name);
//						System.out.println("	Link: " + figureLink);
//							System.out.println("	Home: " + home);
//							System.out.println("	Pass year: " + trangYear);
//							System.out.println("	King: " + king);
//						System.out.println("	Note: " + note);
//							System.out.println("	Desc: " + annotation);
//						getYears(annotation);
//						System.out.println();
