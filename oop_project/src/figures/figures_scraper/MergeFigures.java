...
public class MergeFigures {
	...
	public static void main(String[] args) {
		ArrayList<Figure> figures = EncodeDecode.decodedFigureList(1);
		ArrayList<Figure> figures2 = EncodeDecode.decodedFigureList(2);
		System.out.println(figures.size());
		
		ArrayList<Figure> resList = mergeDynasty(figures, figures2);
		System.out.println(resList.size());
		EncodeDecode.encodeToFile(new ArrayList<>(resList), "final_figures");
