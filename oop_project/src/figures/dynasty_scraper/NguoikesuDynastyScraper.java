...
public class NguoikesuDynastyScraper {
	...
	static List<Object> dynasties = new ArrayList<Object>();
	...
	static void getDynasties(Document doc) {
		...
		EncodeDecode.encodeToFile(NguoikesuDynastyScraper.dynasties, "dynasties");

		List<Dynasty> myNewList = EncodeDecode.decodedDynastyList(false);
		for (Dynasty dynasty: myNewList) {
			HelperFunctions.prtDynastyAttributes(dynasty);
		}
	}
